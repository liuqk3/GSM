...
import pdb
import numpy as np
from lib.utils.bbox import encode_boxes, box_dist
from lib.models.backbone.resnet import ResNetBackbone
from lib.models.reid.reid_model import ReIDModel
from scipy.optimize import linear_sum_assignment
from .utils import binary_cross_entropy_loss, association_neighbor
import time
...
class GraphMatch(nn.Module):
    ...
    def pick_up_neighbors(self, feat, pos_feat, relative_pos, box, neighbor_k, ids=None):
        ...
        if 'learn' in self.neighbor_type: # learn the k neighbors from the features
            ...
            dist = box_dist(tlbr=box) # [bs, num_node, num_node]
    ...
    def get_score(self, feat1, pos_feat1, feat_nei1, pos_feat_nei1, weight_nei1,
        ...
        Args:
            ...
            match_neighbor: bool, whether to match the neighbors
        """
        ...
        if feat_nei1 is not None and feat_nei2 is not None: # this means there is at least one neighbor
            ...
            if self.match_neighbor:
                ...
                score_nei = association_neighbor(score=score_nei_asso, tool='lapjv') # [bs, num_node1, num_node2, neighbor_k]
...
if __name__ == '__main__':
    ...
    conv = nn.Conv1d(in_channels=1, out_channels=32, kernel_size=3, stride=2)
