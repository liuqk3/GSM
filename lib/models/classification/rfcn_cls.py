...
import collections
from lib.models.backbone.squeezenet import DilationLayer, FeatExtractorSqueezeNetx16
from lib.models.psroi_pooling.modules.psroi_pool import PSRoIPool
...
class Model(nn.Module):
    ...
    def get_cls_score_numpy(self, cls_feat, rois, cuda=True):
        """
        ...
        _rois = Variable(torch.from_numpy(_rois))
        if cuda:
            _rois = _rois.cuda(cls_feat.get_device())
