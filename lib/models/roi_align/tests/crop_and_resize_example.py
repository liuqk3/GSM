...
image_data1 = transforms.ToTensor()(plt.imread(img_path1)).unsqueeze(0)
image_data2 = transforms.ToTensor()(plt.imread(img_path2)).unsqueeze(0)
print(image_data1.size())
